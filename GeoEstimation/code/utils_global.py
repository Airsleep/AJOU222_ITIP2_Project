...
def accuracy(output, target, partitioning_shortnames: list, topk=(1, 10, 50, 100, 200, 300, 500)):
...
def summarize_loss_acc_stats(pnames: List[str], outputs, topk=[1, 10, 50, 100, 200, 300, 500]):
