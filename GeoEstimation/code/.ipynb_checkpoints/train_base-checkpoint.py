...
#         topk = utils_global.loss_acc_dict = utils_global.summarize_loss_acc_stats(
#             [p.shortname for p in self.partitionings], outputs
#         )
        return {**result}
...
def parse_args():
    ...
    args.add_argument("--progbar", default=True, action="store_true")
