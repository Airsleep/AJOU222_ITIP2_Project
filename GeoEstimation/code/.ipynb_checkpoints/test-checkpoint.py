...
def parse_args():
    ...
    args.add_argument(
        "--checkpoint",
        type=Path,
        default=Path("/home/ukjung18/GeoEstimation/data/models/base_M_5/221214-0630/ckpts/epoch=004-val_loss=25.2837.ckpt"),
        help="Checkpoint to already trained model (*.ckpt)",
    )
    args.add_argument(
        "--hparams",
        type=Path,
        default=Path("/home/ukjung18/GeoEstimation/data/models/base_M_5/221214-0630/tb_logs/version_0/hparams.yaml"),
...
print("Testing")
r = trainer.test(model, test_dataloaders=dataloader, verbose=True)
# formatting results
dfs = []
